...
Phase 1 ledger implementation is underway. The repository contains an installable React
...
same balanced journal. Full workbook migration and automated importing remain later phases.
