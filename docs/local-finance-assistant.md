...
`qwen3:4b-instruct-2507-q4_K_M`. This instruction-tuned model answers directly
without spending the response budget on hidden reasoning.
...
FINANCE_HERO_OLLAMA_MODEL=qwen3:4b-instruct-2507-q4_K_M
```
